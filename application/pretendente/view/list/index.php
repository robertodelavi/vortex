...
<script>
    ...
    const noPermission = () => {
        toast("Você não tem permissão para acessar este pretendente!<br/>O pretendente selecionado foi atendido por outro corretor.", "danger", 7000);
    }
                    ...
                    columns: [
                        {
                            ...
                            render: (data, cell, row) => {
                                ...
                                if(id > 0){
                                    ...
                                    return `<div class="flex items-center w-max">
                                                <a href="#" onClick="noPermission()" class="hover:text-primary">${data}</a>
                                            </div>`;                                
                                }
                            }
                        },
