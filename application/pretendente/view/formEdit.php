                    ...
                    <div class="flex flex-col sm:flex-row">
                        ...
                        <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input name="nome" id="name" type="text" placeholder="Jimmy Turner"
                                    class="form-input" />
                            </div>
                            <div>
                                <label for="email">E-mail</label>
                                <input name="email" id="email" type="email" placeholder="fulano@email.com"
                                    class="form-input" />
                            </div>
                            <div>
            ...
            <div class="switch">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div class="panel space-y-5">
                        ...
                        <p>Remove the active resource from the cache without waiting for the predetermined cache expiry
                            time.</p>
