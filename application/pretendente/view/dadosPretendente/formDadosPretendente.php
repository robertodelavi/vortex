...
<div class="flex flex-col sm:flex-row" >
    <div class="flex-1 grid sm:grid-cols-2 md:grid-cols-4 gap-5">
        ...
        <div>
            <label for="address">Celular 2</label>
            <input name="prw_fonecelular1" type="text" placeholder="(49) 99999-9999" maxlength="15" class="form-input" value="<?php echo $result[0]['prw_fonecelular1']; ?>" />
        </div>
        <div>
            <label for="address">Tel. Comercial</label>
            <input name="prw_fonecomercial" type="text" placeholder="(49) 9999-9999" maxlength="14" class="form-input" value="<?php echo $result[0]['prw_fonecomercial']; ?>" />
        </div>
        <div>
