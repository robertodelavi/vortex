                    ...
                    <div class="p-5">
                        <div class="dark:text-white-dark/70 text-base font-medium text-[#1f2937]"> 
                            <form method="POST" action="?module=pretendente&acao=grava_visitas">
                                ...
                                <input type="hidden" name="pretendente" id="pretendente" />
...
<script>
    ...
    document.addEventListener("alpine:init", () => {
        Alpine.data("multipleTable", () => ({
                            ...
                            render: (data, cell, row) => {
                                ...
                                <div class="flex gap-4 items-center" >
                                    <button 
                                        ...
                                        @click="() => setPretendente('${idPretendente}', '${nome}');" >
            ...
            setPretendente(id, nome) {
                console.log("🚀 ~ setPretendente:", id, nome)
                document.getElementById("prv_pretendente").value = id;
                document.getElementById("pretendenteNome").innerHTML = nome;
