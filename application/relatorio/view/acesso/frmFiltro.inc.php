...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <form role="form" action="application/relatorio/view/acesso/relatorio.php" target="_blank" id="MyForm" method="post" enctype="multipart/form-data" name="MyForm">
                <div class="row form-group">
                    ...
                    <div class="col-sm-2" >
                        ...
                        <select name="tipo" class="form-control selectpicker show-tick" id="tipo" >
