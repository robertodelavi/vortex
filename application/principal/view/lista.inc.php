<?php 
	$sql = "SELECT count(*) AS qtd FROM financeiro_cliente WHERE fin_situacao = 0";
...
<div x-data="notes">
	<div class="flex gap-5 relative sm:h-[calc(100vh_-_150px)] h-full">
        <div class="bg-black/60 z-10 w-full h-full rounded-md absolute hidden" :class="{ '!block xl:!hidden': isShowNoteMenu }" @click="isShowNoteMenu = !isShowNoteMenu"></div>
        <div class="panel p-4 flex-none w-[240px] absolute xl:relative z-10 space-y-4 h-full xl:h-auto hidden xl:block ltr:lg:rounded-r-md ltr:rounded-r-none rtl:lg:rounded-l-md rtl:rounded-l-none overflow-hidden" :class="{ 'hidden shadow': !isShowNoteMenu, 'h-full ltr:left-0 rtl:right-0': isShowNoteMenu }">
            <div class="flex flex-col h-full pb-16">
                ...
                <div class="perfect-scrollbar relative pr-3.5 -mr-3.5 h-full grow">
                    <div class="space-y-1">
                        <button type="button" class="w-full flex justify-between items-center p-2 hover:bg-white-dark/10 rounded-md dark:hover:text-primary hover:text-primary dark:hover:bg-[#181F32] font-medium h-10" :class="{ 'bg-gray-100 dark:text-primary text-primary dark:bg-[#181F32]': selectedTab === 'all' }" @click="tabChanged('all')">
                        ...
                        <button type="button" class="w-full flex justify-between items-center p-2 hover:bg-white-dark/10 rounded-md dark:hover:text-primary hover:text-primary dark:hover:bg-[#181F32] font-medium h-10" :class="{ 'bg-gray-100 dark:text-primary text-primary dark:bg-[#181F32]': selectedTab === 'fav' }" @click="tabChanged('fav')">
                            <div class="flex items-center">
                        ...
                        <button type="button" class="w-full flex items-center h-10 p-1 hover:bg-white-dark/10 rounded-md dark:hover:bg-[#181F32] font-medium text-primary ltr:hover:pl-3 rtl:hover:pr-3 duration-300" :class="{ 'ltr:pl-3 rtl:pr-3 bg-gray-100 dark:bg-[#181F32]': selectedTab === 'personal' }" @click="tabChanged('personal')">
                        ...
                        <button type="button" class="w-full flex items-center h-10 p-1 hover:bg-white-dark/10 rounded-md dark:hover:bg-[#181F32] font-medium text-warning ltr:hover:pl-3 rtl:hover:pr-3 duration-300" :class="{ 'ltr:pl-3 rtl:pr-3 bg-gray-100 dark:bg-[#181F32]': selectedTab === 'work' }" @click="tabChanged('work')">
                        ...
                        <button type="button" class="w-full flex items-center h-10 p-1 hover:bg-white-dark/10 rounded-md dark:hover:bg-[#181F32] font-medium text-info ltr:hover:pl-3 rtl:hover:pr-3 duration-300" :class="{ 'ltr:pl-3 rtl:pr-3 bg-gray-100 dark:bg-[#181F32]': selectedTab === 'social' }" @click="tabChanged('social')">
                        ...
                        <button type="button" class="w-full flex items-center h-10 p-1 hover:bg-white-dark/10 rounded-md dark:hover:bg-[#181F32] font-medium text-danger ltr:hover:pl-3 rtl:hover:pr-3 duration-300" :class="{ 'ltr:pl-3 rtl:pr-3 bg-gray-100 dark:bg-[#181F32]': selectedTab === 'important' }" @click="tabChanged('important')">
                                            ...
                                            <div class="flex-none">
                                                <template x-if="note.thumb">
                                                    <div class="p-0.5 bg-gray-300 dark:bg-gray-700 rounded-full">
                                                        <img class="h-8 w-8 rounded-full object-cover" :src="`<?php echo BASE_THEME_URL; ?>/assets/images/${note.thumb}`" />
                                                    </div>
                                                </template>
                                                <template x-if="!note.thumb && note.user">
                                                    <div class="grid place-content-center h-8 w-8 rounded-full bg-gray-300 dark:bg-gray-700 text-sm font-semibold" x-text="note.user.charAt(0) + '' + note.user.charAt(note.user.indexOf(' ') + 1)">
                                                    </div>
                                                </template>
                                                <template x-if="!note.thumb && !note.user">
                                            ...
                                            <ul x-cloak x-show="open" x-transition x-transition.duration.300ms class="ltr:right-0 rtl:left-0 text-sm font-medium">
                                                <li>
                                                    <button class="w-full" @click="toggle, editNote(note)">
                                                        ...
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 ltr:mr-3 rtl:ml-3">
                                                ...
                                                <li>
                                                    <button class="w-full" @click="toggle, deleteNoteConfirm(note)">
                                                        ...
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4.5 h-4.5 ltr:mr-3 rtl:ml-3">
                                        ...
                                        <div>
                                            <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                                <a href="javascript:;" :class="{
                                                    ...
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 rotate-45" :class="{
                                                ...
                                                <ul x-cloak x-show="open" x-transition x-transition.duration.300ms class="ltr:left-0 rtl:right-0">
                                                    <li>
                                                        <a href="javascript:;" @click="toggle, setTag(note, 'personal')">

                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 rotate-45 ltr:mr-2 rtl:ml-2 fill-primary">
                                                    ...
                                                    <li>
                                                        <a href="javascript:;" @click="toggle, setTag(note, 'work')">

                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 rotate-45 ltr:mr-2 rtl:ml-2 fill-warning">
                                                                <path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="none" stroke-width="1.5"></path>
                                                            </svg>
                                                            Work</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:;" @click="toggle, setTag(note, 'social')">

                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 rotate-45 ltr:mr-2 rtl:ml-2 fill-info">
                                                                <path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="none" stroke-width="1.5"></path>
                                                            </svg>
                                                            Social</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:;" @click="toggle, setTag(note, 'important')">

                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 rotate-45 ltr:mr-2 rtl:ml-2 fill-danger">
                                                                <path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="none" stroke-width="1.5"></path>
                                                            </svg>
                                                            Important</a>
                                                    </li>
                        ...
                        <div class="p-5">
                            <form @submit.prevent="saveNote">
                                <div class="mb-5">
                                    ...
                                    <input id="title" type="text" placeholder="Enter Title" class="form-input" x-model="params.title" />
                                </div>
                                <div class="mb-5">
                                    <label for="name">User Name</label>
                                    <select id="name" class="form-select" x-model="params.user">
                                ...
                                <div class="mb-5">
                                    ...
                                    <textarea id="desc" rows="3" class="form-textarea resize-none min-h-[130px]" placeholder="Enter Description" x-model="params.description"></textarea>
                                </div>
            ...
            <div class="fixed inset-0 bg-[black]/60 z-[999] px-4 overflow-y-auto hidden" :class="isDeleteNoteModal && '!block'">
                <div class="flex items-center justify-center min-h-screen">
                    <div x-show="isDeleteNoteModal" x-transition x-transition.duration.300 @click.outside="isDeleteNoteModal = false" class="panel border-0 p-0 rounded-lg overflow-hidden md:w-full max-w-lg w-[90%] my-8">
                        ...
                        <div class="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">Delete Notes</div>
                    ...
                    <div x-show="isViewNoteModal" x-transition x-transition.duration.300 @click.outside="isViewNoteModal = false" class="panel border-0 p-0 rounded-lg overflow-hidden md:w-full max-w-lg w-[90%] my-8">
                        ...
                        <div class="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">
                            <div class="flex flex-wrap items-center">
                                ...
                                <div class="flex items-center">
                                    <button x-show="selectedNote.tag" type="button" class="badge badge-outline-primary rounded-3xl capitalize ltr:mr-3 rtl:ml-3" :class="{
        ...
        Alpine.data("notes", () => ({
            ...
            saveNote() {
                ...
                if (this.params.id) {
                    ...
                    //add note
                    let maxNoteId = this.notesList.length ? this.notesList.reduce((max, character) => (character.id > max ? character.id : max), this.notesList[0].id) : 0;
                    if (!maxNoteId) {
                        maxNoteId = 0;
                    }
                    let dt = new Date();
