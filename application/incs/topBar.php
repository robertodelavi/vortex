...
<div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
    ...
    <div x-data="header" class="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
        <div class="hidden sm:block sm:ltr:mr-auto sm:rtl:ml-auto" x-data="{ search: false }" @click.outside="search = false">
        ...
        <div class="hidden sm:block">            
            <a href="#" class="block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60">
                <?php echo file_get_contents('application/icons/refresh.svg'); ?>
            </a>      
        </div>
