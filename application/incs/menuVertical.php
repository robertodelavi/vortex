        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0" x-data="{ activeDropdown: null }">
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{'active' : activeDropdown === 'dashboard'}" @click="activeDropdown === 'dashboard' ? activeDropdown = null : activeDropdown = 'dashboard'">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Sistema</span>
                        </div>
                ...
                <li class="nav-item">
                    <ul>
                        <li class="nav-item">
                            <a href="<?php echo BASE_THEME_URL; ?>/apps/chat.php" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo BASE_THEME_URL; ?>/apps/mailbox.php" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo BASE_THEME_URL; ?>/apps/todolist.php" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Todo List</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo BASE_THEME_URL; ?>/apps/notes" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo BASE_THEME_URL; ?>/apps/scrumboard.php" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Scrumboard</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo BASE_THEME_URL; ?>/apps/contacts.php" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Contacts</span>
                                </div>
                            </a>
                        </li>
                        <li class="menu nav-item">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo BASE_THEME_URL; ?>/apps/calendar.php" class="group">
                                <div class="flex items-center">

                                    <svg class="group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6.94028 2C7.35614 2 7.69326 2.32421 7.69326 2.72414V4.18487C8.36117 4.17241 9.10983 4.17241 9.95219 4.17241H13.9681C14.8104 4.17241 15.5591 4.17241 16.227 4.18487V2.72414C16.227 2.32421 16.5641 2 16.98 2C17.3958 2 17.733 2.32421 17.733 2.72414V4.24894C19.178 4.36022 20.1267 4.63333 20.8236 5.30359C21.5206 5.97385 21.8046 6.88616 21.9203 8.27586L22 9H2.92456H2V8.27586C2.11571 6.88616 2.3997 5.97385 3.09665 5.30359C3.79361 4.63333 4.74226 4.36022 6.1873 4.24894V2.72414C6.1873 2.32421 6.52442 2 6.94028 2Z" fill="currentColor" />
                                        <path opacity="0.5" d="M21.9995 14.0001V12.0001C21.9995 11.161 21.9963 9.66527 21.9834 9H2.00917C1.99626 9.66527 1.99953 11.161 1.99953 12.0001V14.0001C1.99953 17.7713 1.99953 19.6569 3.1711 20.8285C4.34267 22.0001 6.22829 22.0001 9.99953 22.0001H13.9995C17.7708 22.0001 19.6564 22.0001 20.828 20.8285C21.9995 19.6569 21.9995 17.7713 21.9995 14.0001Z" fill="currentColor" />
                                    </svg>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{'active' : activeDropdown === 'components'}" @click="activeDropdown === 'components' ? activeDropdown = null : activeDropdown = 'components'">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Components</span>
                        </div>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'components'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/components/tabs.php">Tabs</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/components/accordions.php">Accordions</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/components/modals.php">Modals</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/components/cards.php">Cards</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/components/carousel.php">Carousel</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/components/countdown.php">Countdown</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/components/counter.php">Counter</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/components/sweetalert.php">Sweet Alerts</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/components/timeline.php">Timeline</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/components/notifications.php">Notifications</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/components/media-object.php">Media Object</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/components/list-group.php">List Group</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/components/pricing-table.php">Pricing Tables</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/components/lightbox.php">Lightbox</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{'active' : activeDropdown === 'elements'}" @click="activeDropdown === 'elements' ? activeDropdown = null : activeDropdown = 'elements'">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Elements</span>
                        </div>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'elements'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/alerts.php">Alerts</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/avatar.php">Avatar</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/badges.php">Badges</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/breadcrumbs.php">Breadcrumbs</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/buttons.php">Buttons</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/buttons-group.php">Button Groups</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/color-library.php">Color Library</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/dropdown.php">Dropdown</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/infobox.php">Infobox</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/jumbotron.php">Jumbotron</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/loader.php">Loader</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/pagination.php">Pagination</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/popovers.php">Popovers</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/progress-bar.php">Progress Bar</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/search.php">Search</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/tooltips.php">Tooltips</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/treeview.php">Treeview</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/elements/typography.php">Typography</a>
                        </li>
                    </ul>
                </li>

                <li class="menu nav-item">
                    <a href="<?php echo BASE_THEME_URL; ?>/charts.php" class="nav-link group">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Charts</span>
                        </div>
                    </a>
                </li>

                <li class="menu nav-item">
                    <a href="<?php echo BASE_THEME_URL; ?>/widgets.php" class="nav-link group">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Widgets</span>
                        </div>
                    </a>
                </li>

                <li class="menu nav-item">
                    <a href="<?php echo BASE_THEME_URL; ?>/font-icons.php" class="nav-link group">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Font Icons</span>
                        </div>
                    </a>
                </li>

                <li class="menu nav-item">
                    <a href="<?php echo BASE_THEME_URL; ?>/dragndrop.php" class="nav-link group">
                        <div class="flex items-center">
                            ...
                            <svg class="group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M13.25 7C13.25 7.41421 13.5858 7.75 14 7.75H15.1893L12.9697 9.96967C12.6768 10.2626 12.6768 10.7374 12.9697 11.0303C13.2626 11.3232 13.7374 11.3232 14.0303 11.0303L16.25 8.81066V10C16.25 10.4142 16.5858 10.75 17 10.75C17.4142 10.75 17.75 10.4142 17.75 10V7C17.75 6.58579 17.4142 6.25 17 6.25H14C13.5858 6.25 13.25 6.58579 13.25 7Z" fill="currentColor" />
                                ...
                                <path d="M10.75 7C10.75 7.41421 10.4142 7.75 10 7.75H8.81066L11.0303 9.96967C11.3232 10.2626 11.3232 10.7374 11.0303 11.0303C10.7374 11.3232 10.2626 11.3232 9.96967 11.0303L7.75 8.81066V10C7.75 10.4142 7.41421 10.75 7 10.75C6.58579 10.75 6.25 10.4142 6.25 10V7C6.25 6.58579 6.58579 6.25 7 6.25H10C10.4142 6.25 10.75 6.58579 10.75 7Z" fill="currentColor" />
                                <path d="M12.9697 14.0303C12.6768 13.7374 12.6768 13.2626 12.9697 12.9697C13.2626 12.6768 13.7374 12.6768 14.0303 12.9697L16.25 15.1893V14C16.25 13.5858 16.5858 13.25 17 13.25C17.4142 13.25 17.75 13.5858 17.75 14V17C17.75 17.4142 17.4142 17.75 17 17.75H14C13.5858 17.75 13.25 17.4142 13.25 17C13.25 16.5858 13.5858 16.25 14 16.25H15.1893L12.9697 14.0303Z" fill="currentColor" />
                            </svg>
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Drag and Drop</span>
                        </div>
                    </a>
                </li>
                ...
                <li class="menu nav-item">
                    <a href="<?php echo BASE_THEME_URL; ?>/tables.php" class="nav-link group">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Tables</span>
                        </div>
                    </a>
                </li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class=" {'active' : activeDropdown==='datatables' }" @click="activeDropdown === 'datatables' ? activeDropdown = null : activeDropdown = 'datatables'">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Data Tables</span>
                        </div>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'datatables'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/datatables/basic.php">Basic</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/datatables/advanced.php">Advanced</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/datatables/skin.php">Skin</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/datatables/order-sorting.php">Order Sorting</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/datatables/multi-column.php">Multi Column</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/datatables/multiple-tables.php">Multiple Tables</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/datatables/alt-pagination.php">Alt. Pagination</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/datatables/checkbox.php">Checkbox</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/datatables/range-search.php">Range Search</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/datatables/export.php">Export</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/datatables/sticky-header.php">Sticky Header</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/datatables/clone-header.php">Clone Header</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/datatables/column-chooser.php">Column Chooser</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{'active' : activeDropdown === 'forms'}" @click="activeDropdown === 'forms' ? activeDropdown = null : activeDropdown = 'forms'">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Forms</span>
                        </div>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'forms'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/forms/basic.php">Basic</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/forms/input-group.php">Input Group</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/forms/layouts.php">Layouts</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/forms/validation.php">Validation</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/forms/input-mask.php">Input Mask</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/forms/select2.php">Select2</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/forms/touchspin.php">TouchSpin</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/forms/checkbox-radio.php">Checkbox & Radio</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/forms/switches.php">Switches</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/forms/wizards.php">Wizards</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/forms/file-upload.php">File Upload</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/forms/quill-editor.php">Quill Editor</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/forms/markdown-editor.php">Markdown Editor</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/forms/date-picker.php">Date & Range Picker</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/forms/clipboard.php">Clipboard</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'users'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/users/profile.php">Profile</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/users/user-account-settings.php">Account Settings</a>
                        </li>
                    </ul>
                </li>
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{'active' : activeDropdown === 'pages'}" @click="activeDropdown === 'pages' ? activeDropdown = null : activeDropdown = 'pages'">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Pages</span>
                        </div>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'pages'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/pages/knowledge-base.php">Knowledge Base</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/pages/contact-us.php" target="_blank">Contact Form</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/pages/faq.php">Faq</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/pages/coming-soon.php" target="_blank">Coming Soon</a>
                        </li>
                        <li x-data="{subActive:null}">
                            <button type="button" class="before:bg-gray-300 before:w-[5px] before:h-[5px] before:rounded ltr:before:mr-2 rtl:before:ml-2 dark:text-[#888ea8] hover:bg-gray-100 dark:hover:bg-gray-900" @click="subActive === 'error' ? subActive = null : subActive = 'error'">Error
                            ...
                            <ul class="sub-menu text-gray-500 ltr:ml-2 rtl:mr-2" x-show="subActive === 'error'" x-collapse>
                                <li>
                                    <a href="<?php echo BASE_THEME_URL; ?>/pages/error404.php" target="_blank">404</a>
                                </li>
                                <li>
                                    <a href="<?php echo BASE_THEME_URL; ?>/pages/error500.php" target="_blank">500</a>
                                </li>
                                <li>
                                    <a href="<?php echo BASE_THEME_URL; ?>/pages/error503.php" target="_blank">503</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/pages/maintenence.php" target="_blank">Maintanence</a>
                        </li>
                    </ul>
                </li>
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{'active' : activeDropdown === 'authentication'}" @click="activeDropdown === 'authentication' ? activeDropdown = null : activeDropdown = 'authentication'">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Authentication</span>
                        </div>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'authentication'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/auth/boxed-signin.php" target="_blank">Login Boxed</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/auth/boxed-signup.php" target="_blank">Register Boxed</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/auth/boxed-lockscreen.php" target="_blank">Unlock Boxed</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/auth/boxed-password-reset.php" target="_blank">Recover ID Boxed</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/auth/cover-login.php" target="_blank">Login Cover</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/auth/cover-register.php" target="_blank">Register Cover</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/auth/cover-lockscreen.php" target="_blank">Unlock Cover</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_THEME_URL; ?>/auth/cover-password-reset.php" target="_blank">Recover ID Cover</a>
                        </li>
                    </ul>
                </li>
