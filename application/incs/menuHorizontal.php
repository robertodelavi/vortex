...
<ul class="horizontal-menu hidden py-1.5 font-semibold px-6 lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse bg-white border-t border-[#ebedf2] dark:border-[#191e3a] dark:bg-[#0e1726] text-black dark:text-white-dark">
    ...
    <li class="menu nav-item relative">
        ...
        <ul class="sub-menu">
            <li>
                <a href="<?php echo BASE_THEME_URL; ?>/tables.php">Tables</a>
            </li>
            <li class="relative">
    ...
    <li class="menu nav-item relative">
        ...
        <ul class="sub-menu">
            <li>
                <a href="<?php echo BASE_THEME_URL; ?>/dragndrop.php">Drag and Drop</a>
            </li>
            <li>
                <a href="<?php echo BASE_THEME_URL; ?>/charts.php">Charts</a>
            </li>
            <li>
                <a href="<?php echo BASE_THEME_URL; ?>/font-icons.php">Font Icons</a>
            </li>
            <li>
                <a href="<?php echo BASE_THEME_URL; ?>/widgets.php">Widgets</a>
            </li>
            <li>
