            ...
            <div class="md:absolute md:top-5 ltr:md:left-5 rtl:md:right-5">
                <div class="flex items-center gap-2 mb-5">
                    <button type="button" class="btn btn-danger gap-2" @click="deleteRow()">
                        ...
                        Delete </button>
                    <a href="/apps/invoice/add.php" class="btn btn-primary gap-2">
                ...
                this.datatable = new simpleDatatables.DataTable('#myTable', {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            select: 1,
                            render: function(data, cell, row) {
                                return '<a href="/apps/invoice/preview.php" class="text-primary underline font-semibold hover:no-underline">#' + data + '</a>';
                            }
                        },
                        {
                            select: 2,
                            render: function(data, cell, row) {
                                return `<div class="flex items-center font-semibold"><div class="p-0.5 bg-white-dark/30 rounded-full w-max ltr:mr-2 rtl:ml-2"><img class="h-8 w-8 rounded-full object-cover" src="<?php echo BASE_THEME_URL; ?>/assets/images/profile-${row.dataIndex + 1}.jpeg" /></div>${data}</div>`;
                            }
                        },
                        {
                            select: 5,
                        ...
                        },
                        {
                            ...
                            render: function(data, cell, row) {
                                return `<div class="flex gap-4 items-center">
                                            <a href="/apps/invoice/edit.php" class="hover:text-info">
                                            ...
                                            <a href="/apps/invoice/preview.php" class="hover:text-primary">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5">
                                                    <path
                                                        opacity="0.5"
