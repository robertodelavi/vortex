...
<div class="flex justify-center items-center min-h-screen bg-[url('/assets/images/map.svg')] dark:bg-[url('/assets/images/map-dark.svg')] bg-cover bg-center">
    <div class="panel sm:w-[480px] m-6 max-w-lg w-full">
        <h2 class="font-bold text-2xl mb-5">
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 inline-block ltr:mr-1 rtl:ml-1 text-primary">
                ...
                <path d="M20.9605 15.5C21.6259 16.1025 22 16.7816 22 17.5C22 19.9853 17.5228 22 12 22C6.47715 22 2 19.9853 2 17.5C2 16.7816 2.37412 16.1025 3.03947 15.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
            </svg>
            Contact Us
        </h2>
        <p class="mb-7">Submit your queries and we will get back to you as soon as possible.</p>
        <form class="space-y-4" @submit.prevent="window.location='/'">
            <div class="relative">
            ...
            <div class="relative">
                <span class="absolute ltr:left-2 rtl:right-2 top-2.5 text-primary">
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5">
                        ...
                        <path opacity="0.5" d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                    </svg>
                </span>
