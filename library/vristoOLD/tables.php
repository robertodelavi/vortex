    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-6" x-data="form">
        ...
        <div class="panel">
            <div class="flex items-center justify-between mb-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Simple Table</h5>
                <a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600" href="javascript:;" @click="toggleCode('code1')">
                    <span class="flex items-center">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ltr:mr-2 rtl:ml-2">
                            ...
                            <path d="M7.00005 7.82959L5.30358 9.35641C3.76102 10.7447 2.98975 11.4389 2.98975 12.3296C2.98975 13.2203 3.76102 13.9145 5.30358 15.3028L7.00005 16.8296" stroke="currentColor" stroke-width="1.5"
...
&lt;/script&gt;
        ...
        <div class="panel">
            <div class="flex items-center justify-between mb-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Hover Table</h5>
...
&lt;/script&gt;
        ...
        <div class="panel">
            <div class="flex items-center justify-between mb-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Striped Table</h5>
...
&lt;/script&gt;
        ...
        <div class="panel">
            <div class="flex items-center justify-between mb-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Table Light</h5>
...
&lt;/script&gt;
        ...
        <div class="panel">
            <div class="flex items-center justify-between mb-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Captions</h5>
                        ...
                        <tbody>
                            <template x-for="data in tableData" :key="data.id">
                                <tr>
                                    ...
                                    <td x-text="data.name" class="whitespace-nowrap"></td>
                                    <td x-text="data.email"></td>
                                    <td> <span class="badge whitespace-nowrap"
...
&lt;/script&gt;
        ...
        <div class="panel">
            <div class="flex items-center justify-between mb-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Progress Table</h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="h-1.5 bg-[#ebedf2] dark:bg-dark/40 rounded-full flex w-full">
                                            <div class="h-1.5 rounded-full rounded-bl-full text-center text-white text-xs"
                                                :class="{'bg-success': data.status === 'Complete', 'bg-secondary': data.status === 'Pending', 'bg-info': data.status === 'In Progress', 'bg-danger': data.status === 'Canceled'}"
...
&lt;/script&gt;
        ...
        <div class="panel">
            <div class="flex items-center justify-between mb-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Contextual</h5>
...
&lt;/div&gt;
        ...
        <div class="panel">
            <div class="flex items-center justify-between mb-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Dropdown</h5>
                        ...
                        <tbody>
                            <template x-for="data in tableData" :key="data.id">
                                <tr>
                                    ...
                                    <td x-text="data.sale"></td>
                                    <td> <span class="badge whitespace-nowrap"
                                            :class="{'bg-primary': data.status === 'Complete', 'bg-secondary': data.status === 'Pending', 'bg-success': data.status === 'In Progress', 'bg-danger': data.status === 'Canceled'}"
                                            x-text="data.status"></span></td>
                                    <td class="text-center">
                                        <div x-data="dropdown" @click.outside="open = false" class="dropdown w-max">
                                            <a href="javascript:;" class="inline-block" @click="toggle">

                                                <svg class="w-5 h-5 opacity-70 m-auto" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
&lt;/script&gt;
        ...
        <div class="panel">
            <div class="flex items-center justify-between mb-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Table with Footer</h5>
                        ...
                        <tbody>
                            <template x-for="data in tableData" :key="data.id">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <ul class="flex items-center justify-center gap-2">
                                            <li><a href="javascript:;" x-tooltip="Settings">
                                            ...
                                            <li><a href="javascript:;" x-tooltip="Edit">
                                            ...
                                            <li><a href="javascript:;" x-tooltip="Delete">
