        ...
        Alpine.data("basic", () => ({
            ...
            init() {
                this.datatable = new simpleDatatables.DataTable('#myTable', {
                    data: {
                        headings: ["ID", "User", "Country", "Email", "Progress", "Phone", "<div class='text-center'>Rate</div>", "Progress", "Status"],
                        data: [
                            ...
                            [6, 'Buckley Townsend', '', 'buckleytownsend@orbaxter.com', 40, '+1 (884) 595-2643', '', '', ''],
                            ...
                            [22, 'Carmella Mccarty', '', 'carmellamccarty@sybixtex.com', 21, '+1 (876) 456-3218', '', '', ''],
