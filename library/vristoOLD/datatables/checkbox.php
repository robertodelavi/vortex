...
<div x-data="custom">
    <div class="space-y-6">
        <div class="panel">
            <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Checkbox</h5>
        ...
        Alpine.data("custom", () => ({
            ...
            init() {
                this.datatable = new simpleDatatables.DataTable('#myTable', {
                    data: {
                        headings: ['<input type="checkbox" class="form-checkbox" :value="ids.length === tableData.length" @change="checkAll($event.target.checked)" />', "ID", "First Name", "Last Name", "Email", "Phone"],
                        data: this.tableData,
                    },
                    perPage: 10,
