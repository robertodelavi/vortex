...
<div x-data="pagination">
    <div class="panel">
        <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Alt Pagination</h5>
        <table id="myTable1" class="whitespace-nowrap"></table>
    </div>

    <div class="panel mt-6">
        <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Disable First Last Pagination</h5>
        <table id="myTable2" class="whitespace-nowrap"></table>
    </div>

    <div class="panel mt-6 no-number-pagination">
        <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Pagination Without Number</h5>
        <table id="myTable3" class="whitespace-nowrap"></table>
    </div>

    <div class="panel mt-6 no-number-pagination next-prev-pagination">
        <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Next Previous</h5>
    ...
    document.addEventListener("alpine:init", () => {
        Alpine.data("pagination", () => ({
            init() {
                ...
                const datatable3 = new simpleDatatables.DataTable('#myTable3', {
                    ...tableOptions,
                    firstLast: true,
                    firstText: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4.5 h-4.5 rtl:rotate-180"> <path d="M13 19L7 12L13 5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/> <path opacity="0.5" d="M16.9998 19L10.9998 12L16.9998 5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/> </svg>',
                    lastText: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4.5 h-4.5 rtl:rotate-180"> <path d="M11 19L17 12L11 5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/> <path opacity="0.5" d="M6.99976 19L12.9998 12L6.99976 5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/> </svg>',
