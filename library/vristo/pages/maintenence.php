...
<div class="flex justify-center items-center min-h-screen bg-gradient-to-t from-[#c39be3] to-[#f2eafa]">
    <div class="text-center p-5">
        ...
        <p class="text-base">We are currently working on making some improvements <br class="sm:block hidden">to give you better user experience. <br> <br>Please visit us again shortly.</p>
