...
<div x-data="striped">
    <div class="panel">
        <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Skin: Striped</h5>
        <table id="tableStripe" class="table-striped"></table>
    </div>

    <div class="panel mt-6">
        <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Skin: Hover</h5>
        <table id="tableHover" class="table-hover"></table>
    </div>

    <div class="panel mt-6">
        <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Skin: Bordered</h5>
        <table id="tableBorder" class="table-bordered"></table>
    </div>

    <div class="panel mt-6">
        <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Skin: Compact</h5>
        <table id="tableCompact" class="table-compact"></table>
    </div>

    <div class="panel mt-6">
        <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Skin: All</h5>
