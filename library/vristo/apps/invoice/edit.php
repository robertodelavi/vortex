            ...
            <div class="flex justify-between flex-wrap px-4">
                ...
                <div class="lg:w-1/2 w-full lg:max-w-fit">
                    <div class="flex items-center">
                        ...
                        <input id="number" type="text" name="inv-num" class="form-input lg:w-[250px] w-2/3" placeholder="#8801" x-model="params.invoiceNo" />
                    </div>
                    <div class="flex items-center mt-4">
                        <label for="invoiceLabel" class="flex-1 ltr:mr-2 rtl:ml-2 mb-0">Invoice Label</label>
                        <input id="invoiceLabel" type="text" name="inv-label" class="form-input lg:w-[250px] w-2/3" placeholder="Enter Invoice Label" x-model="params.title" />
                    </div>
                    <div class="flex items-center mt-4">
                        <label for="startDate" class="flex-1 ltr:mr-2 rtl:ml-2 mb-0">Invoice Date</label>
                        <input id="startDate" type="date" name="inv-date" class="form-input lg:w-[250px] w-2/3" x-model="params.invoiceDate" />
                    </div>
                    <div class="flex items-center mt-4">
                        <label for="dueDate" class="flex-1 ltr:mr-2 rtl:ml-2 mb-0">Due Date</label>
                        <input id="dueDate" type="date" name="due-date" class="form-input lg:w-[250px] w-2/3" x-model="params.dueDate" />
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                <template x-for="(item, i) in items" :key="i">
                                    <tr class="align-top border-b border-[#e0e6ed] dark:border-[#1b2e4b]">
                                        ...
                                        <td><input type="number" class="form-input w-32" placeholder="Quantity" x-model="item.quantity" min="0"/></td>
                                        <td><input type="number" class="form-input w-32" placeholder="Price" x-model="item.amount" min="0"/></td>
        ...
        <div class="xl:w-96 w-full xl:mt-0 mt-6">
            <div class="panel mb-5">
                ...
                <div class="mt-4">
                    <div>
                        ...
                        <input id="shipping-charge" type="number" name="shipping-charge" class="form-input" placeholder="Shipping Charge" x-model="shippingCharge" />
                    </div>
                </div>
                <div class="mt-4">
            ...
            <div class="panel">
                <div class="grid xl:grid-cols-1 lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-4">
                    ...
                    <a href="/apps/invoice/preview.php" class="btn btn-primary w-full gap-2">
